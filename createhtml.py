...
def create_full_html():
    ...
    files = glob.glob(os.path.join(os.path.join(os.getcwd(), "html_files", "*.htm")))

    series1_contents = BeautifulSoup(open(os.path.join("html_files", "scp-series-contents.html"), encoding="utf8"))
    result_soup.find("div", id="toc").append(series1_contents.find("div", id="main-content"))
    ...
    result_soup.find("div", id="toc").append(series2_contents.find("div", id="main-content"))
    result_soup.find("div", id="toc").append(result_soup.new_tag("br"))
    ...
    for file in files:
            ...
            result_soup.find("div", id="articles").append(file_soup.find("div", id="container"))
            result_soup.find("div", id="articles").append(result_soup.new_tag("br"))

    f = open(os.path.join("encyclopedia", "SCP Encyclopedia.htm"), 'w', encoding="utf8")
